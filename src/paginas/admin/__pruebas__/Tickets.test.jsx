...
import { useTickets } from "../../../ganchos/useTickets";
import { useSensores } from "../../../ganchos/useSensores";
import { crearTicket, actualizarEstadoTicket } from "../../../utilidades/api";

vi.mock("../../../ganchos/useTickets", () => ({ useTickets: vi.fn() }));
vi.mock("../../../ganchos/useSensores", () => ({ useSensores: vi.fn() }));
vi.mock("../../../utilidades/api", () => ({ crearTicket: vi.fn(), actualizarEstadoTicket: vi.fn() }));
